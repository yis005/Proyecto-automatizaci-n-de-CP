...
Script en Python que recorre carpetas con PDFs DIAN, extrae facturas (campo 40) y valores (campo 52), suma montos de facturas repetidas y exporta un Excel con datos consolidados, incluyendo número de formulario y código de barras.

📑 Proyecto: Extracción de Facturas desde PDFs DIAN
📌 Descripción
